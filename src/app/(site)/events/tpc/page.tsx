...
const TPC = async () => {
  ...
  try {
    ...
    // Check if tpcPage exists in the response
    if (!data || !data.tpcPage) {
      console.error('TPC Page data not found');
      // Return a fallback UI or error page
      return (
        <main className='w-full min-h-screen flex items-center justify-center'>
          <div className='text-center p-8'>
            <h1 className='text-2xl font-bold text-cream-secondary-light mb-4'>
              Content Unavailable
            </h1>
            <p className='text-cream-secondary-light'>
              We&apos;re unable to load the TPC page content at this time.
    ...
    const { tpcPage, allFaqTpcs = [], allTimelineTpcs = [] } = data;
    ...
    return (
      <main className='w-full min-h-screen flex items-center justify-center'>
        <div className='text-center p-8'>
          ...
          <p className='text-cream-secondary-light'>
            We&apos;re unable to load the TPC page content at this time. Please
            try again later.
          </p>
        </div>
      </main>

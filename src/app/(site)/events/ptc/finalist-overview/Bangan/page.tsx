...
const PTCTeamInformation = () => {
  const [teamInfo, setTeamInfo] = useState({
    data: {
      ...
      chairmanEmail: 'waduh',
      members: [
        { name: 'Muhammad Athariq Yurisqi Riswandi' },
        { name: 'Edwin Juanda Samuel Sirait' },
        { name: 'Muhammad Khairan Azzam' },
        { name: 'Muhammad Dzaky Kamal' },
        { name: 'Mochammad Naufal Hakim' },
      ],
      teamStatus: 'ga',
      topicName: 'Hysteresis Dynamic Response Adapter (HYDRA)',
      abstract: { status: '' },
        ...
        <section className='flex flex-col text-white font-museo-muderno gap-6 p-4'>
          ...
          <div className='relative h-fit min-h-[50%] w-full p-4 lg:px-8 rounded-md bg-[#49784F] mx-auto'>
            ...
            <p className='max-w-full md:max-w-[50%] font-bold leading-loose text-justify'>
              HYDRA offers a bidirectional inverter with an extremely fast
              dynamic response, making it highly suitable for addressing new
              renewable energy sources with intermittency dependency.
              Additionally, HYDRA has good efficiency values, enabling it to
              provide more optimal power compared to conventional inverters.
            </p>
            <div className='grid grid-cols-2 h-fit py-4 lg:pt-16 gap-8'>
              <div className='flex'>
                <Image
                  src='https://res.cloudinary.com/dggk9y0yt/image/upload/v1709939053/The%20Sandbox%20by%20IEEE%20ITBSB/PTCModels/Bangan/b9hfmlhn0h16sg1lzweh.jpg'
                  width={600}
                  height={600}
                  alt='Mascot'
              ...
              <div className='flex'>
                <Image
                  src='https://res.cloudinary.com/dggk9y0yt/image/upload/v1709939049/The%20Sandbox%20by%20IEEE%20ITBSB/PTCModels/Bangan/xhzjol7l2quvzchpphvp.jpg'
                  width={600}
                  height={600}
                  alt='Mascot'
                  className='min-w-full w-0 h-fit m-auto'
              ...
              <div className='flex'>
                <Image
                  src='https://res.cloudinary.com/dggk9y0yt/image/upload/v1709939044/The%20Sandbox%20by%20IEEE%20ITBSB/PTCModels/Bangan/junltoeuzpewg627jakm.jpg'
                  width={600}
                  height={600}
                  alt='Mascot'
                  className='min-w-full w-0 h-fit m-auto'
              ...
              <div className='flex'>
                <Image
                  src='https://res.cloudinary.com/dggk9y0yt/image/upload/v1709939041/The%20Sandbox%20by%20IEEE%20ITBSB/PTCModels/Bangan/iztpysj2z2omy8vtbzi9.jpg'
                  width={600}
                  height={600}
                  alt='Mascot'
                  className='min-w-full w-0 h-fit m-auto'
      ...
      <section className='w-full max-w-[1240px] mx-auto flex flex-col justify-center items-center py-16 bg-[#0E3D1F] rounded-lg gap-8'>
        ...
        <div className='w-full max-w-[80%] h-auto aspect-[5/3]'>
          <iframe
            ...
            width='847'
            height='476'
            src='https://www.youtube.com/embed/yhfy1z9UmRE'
            title='Video Demonstrasi HYDRA - Team Bangan'

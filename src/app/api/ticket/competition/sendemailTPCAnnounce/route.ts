...
export async function POST(req: NextRequest) {
  try {
    ...
    const failedMsg = `Dear Semi-finalist of The Sandbox Technovate Paper Competition,
      ...
      Once again, we express our deepest gratitude for your participation in The Sandbox Technovate Paper Competition. Your commitment to pushing the boundaries of innovation is truly inspiring, and we look forward to witnessing your continued success on this exciting journey.
      ...
      Head of Competition
      The Sandbox Technovate Paper Competition Team
      IEEE ITB SB`;
    ...
    const successMsg = `
      ...
      https://drive.google.com/file/d/1YfLhL4V6FwLaEgw7dHGNwTasNBqn4Czb/view

      You can join our WhatsApp Group by clicking the link provided below.

      https://chat.whatsapp.com/LTfvMIB0BJx2TcgQRp69Pp

      Thank you and best of luck!`;

    const heading = `TPC Finalist Announcement`;
    ...
    for (const data of failedTeams) {
      const mailOptions = {
        ...
        subject: `[SANDBOX] TPC Finalist Announcement`,
        html: render(
          Email({
            heading: heading,
            content: failedMsg,
